...
# owner, balancerVault, uniV3, sushiV3, quickV3, aavePool, poolManager,
# uniV2, sushiV2, quickV2, quickV4(sentinel) → slots 0x00, 0x07..0x10
INIT_ARGS=$(cast calldata "initialize(address,address,address,address,address,address,address,address,address,address,address)" \
  "$OWNER" \
